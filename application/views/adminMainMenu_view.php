...
<html>
    ...
    <body>
        ...
        <div id="adminForm" >
    		...
    		<button id="manageAccountsButton" onclick="loadEmployees()">Manage Accounts</button><br>
            <button id="googleCalendarButton" onclick="loadGoogleCalendar()">Google Calendar</button><br>
